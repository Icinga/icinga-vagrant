...
class icingaweb2-internal-db-mysql {
  ...
  exec { 'populate-icingaweb-mysql-db':
    ...
    command => 'mysql -uicingaweb2 -picingaweb2 icingaweb2 < /usr/share/icingaweb2/schema/mysql.schema.sql; mysql -uicingaweb2 -picingaweb2 icingaweb2 -e "INSERT INTO icingaweb2_user (name, active, password_hash) VALUES (\'icingaadmin\', 1, \'\$1\$iQSrnmO9\$T3NVTu0zBkfuim4lWNRmH.\');"',
